...
html -> { <<~HTML # rubocop:todo Metrics
  <iv-fetch id="signed" href="/booking/signed-in"></iv-fetch>
  <iv-form><form action="/booking/submit" method="post" style="min-height: 80vh; max-width: 70ch; margin-inline: auto">
